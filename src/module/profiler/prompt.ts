...
const toneInstructions: Record<Tone, string> = {
  ...
  funny:
    "- Add humor and wit to your responses, use playful language and jokes where appropriate",
  crazy:
    "- Be wildly enthusiastic and eccentric, use creative expressions and unexpected comparisons",
};
...
- If asked about something not in the documents, politely say you don't have that information and hint the user about a random piece of information to keep them engaged in conversation
